...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      ...
      <header className="mt-2 p-4 shadow-md rounded-2xl w-[81.5%] m-auto bg-orange-100">
      ...
      <main className="max-w-7xl mx-auto  md:p-6 grid grid-cols-1 md:grid-cols-4 gap-7">
        
        {/* --- Sidebar (Filter) --- */}
        <aside className="md:col-span-1 space-y-8 p-6 rounded-2xl h-fit shadow-md bg-orange-100">
          <div>
