...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      <Navbar/>
      <div className='md:w-[90%] sm:w-[100%] h-[250px] rounded-3xl mt-2 bg-amber-200 m-auto overflow-hidden  border-[3px] border-orange-950'>
          <img className='w-[100%] h-[100%] object-cover' src={background} alt="" />
      </div>
      <div className='w-[90%] m-auto rounded-3xl mb-6 bg-gradient-to-r from-orange-900/40 via-orange-900/10 to-orange-900/40'>
      ...
      <main className="w-[90%] m-auto md:p-6 grid grid-cols-1 md:grid-cols-4 gap-7">
        ...
        {/* --- Sidebar (Filter) --- */}
        <aside className="md:col-span-1 space-y-8 p-6 rounded-2xl h-fit shadow-md bg-gray-300 ">
          <div>
