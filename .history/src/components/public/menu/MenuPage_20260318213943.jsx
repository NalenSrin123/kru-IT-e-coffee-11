...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      ...
      <div className='w-[90%] m-auto rounded-3xl mb-6 <div class="bg-gradient-to-l from-orange-950/0 via-orange-950/40 to-orange-950/0"></div'>
      ...
      <main className="w-[90%] m-auto md:p-6 grid grid-cols-1 md:grid-cols-4 gap-7">
        ...
        {/* --- Sidebar (Filter) --- */}
        <aside className="md:col-span-1 space-y-8 p-6 rounded-2xl h-fit shadow-md bg-white ">
          <div>
