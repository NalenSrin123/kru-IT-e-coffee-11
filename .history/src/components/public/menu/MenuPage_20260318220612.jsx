...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      ...
      <div className='w-[100%] sm:w-[90%] m-auto rounded-3xl overflow-hidden mb-8 bg-gradient-to-r from-orange-900/40 via-orange-900/10 to-orange-900/40'>
      <div className='w-[100%] h-[250px]  mt-2 bg-amber-200 m-auto overflow-hidden  border-[3px] border-orange-950'>
