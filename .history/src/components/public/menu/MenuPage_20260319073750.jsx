      ...
      <main className="w-[95%] m-auto md:p-6 grid grid-cols-1 lg:grid-cols-4 gap-7">
        ...
        <div className="lg:col-span-3 ">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((item) => (
              <div key={item.id} className="bg-white p-6 rounded-2xl overflow-hidden overflow-hidden shadow-sm hover:shadow-xl transition-all group border border-transparent hover:border-amber-100">
