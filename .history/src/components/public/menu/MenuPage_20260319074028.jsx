          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((item) => (
              <div key={item.id} className="bg-white p-6 rounded-2xl overflow-hidden  shadow-sm hover:shadow-xl transition-all group border border-transparent hover:border-amber-100">
                ...
                <div className="">
                  <h4 className="font-bold text-lg  p-2 group-hover:text-amber-800 transition-colors">{item.name}</h4>
                  <p className="text-gray-500 text-[16px] mb-4 line-clamp-2">{item.desc}</p>
