...
import background from "../../../assets/images/coffee/background_coffee.jpg";
...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      <Navbar/>
      <div className='w-[90%] h-[250px] rounded-3xl mt-2 bg-amber-200 m-auto'>
          <img className='w-[100%] h-[100%] obj' src={background} alt="" />
      </div>
      {/* --- Header & Search Section --- */}
      <header className="mt-2 p-4 shadow-md rounded-2xl w-[90%] m-auto">
