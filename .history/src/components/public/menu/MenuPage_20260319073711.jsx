            ...
            {products.map((item) => (
              <div key={item.id} className="bg-white p-6 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all group border border-transparent hover:border-amber-100">
                <div className="relative h-56 overflow-hidden">
                  <img src={item.image} alt={item.name} className="w-full h-full rounded-2xl object-cover group-hover:scale-110 group-hover:rounded-2xl transition-transform duration-500" />
                </div>
                <div className="">
