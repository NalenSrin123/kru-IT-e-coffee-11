...
const MenuPage = () => {
  ...
  return (
    <div className="min-h-screen text-gray-800 ">
      ...
      <div className='w-[100%] sm:w-[90%] m-auto rounded-3xl overflow-hidden mt-3 mb-8 bg-gradient-to-r from-orange-900/40 via-orange-900/10 to-orange-900/40'>
      <div className='w-[100%] h-[250px] bg-amber-200 m-auto overflow-hidden  border-[3px] border-orange-950'>
      ...
      <main className="w-[95%] m-auto md:p-6 grid grid-cols-1 lg:grid-cols-4 gap-7">
        ...
        {/* --- Sidebar (Filter) --- */}
        <aside className="md:col-span-1 space-y-8 p-6 rounded-2xl h-[100%] shadow-md bg-gray-50 ">
          <div>
        ...
        <div className="lg:col-span-3 ">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((item) => (
              <div key={item.id} className="bg-white p-6 rounded-2xl overflow-hidden  shadow-sm hover:shadow-xl transition-all group border border-transparent hover:border-amber-100">
                <div className="relative h-56 overflow-hidden rounded-2xl overflow-hidden">
                ...
                <div className="">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <button className="bg-amber-0 text-amber-800 px-4 py-2 rounded-xl font-semibold text-sm flex items-center gap-2 hover:bg-amber-800 hover:text-white transition-all">
                      Add to Cart
                    </button>
                  </div>
                </div>
