      ...
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 overflow-hidden shadow-2xl ">
        ...
        <div className="w-[600px] h-[320px] px-20 flex flex-col items-center">
              ...
              <div className="flex gap-4 mt-10">
                <button className="bg-amber-800 px-8 py-3 border-[2px] border-orange-800  hover:bg-amber-700 transition rounded-3xl">Order Now</button>
                <button className="bg-gray-600 text-white border-[2px] border-gray-500 px-8 py-3  hover:bg-gray-500 transition rounded-3xl">View More</button>
              </div>
        </div>
        </div>
      </div>
