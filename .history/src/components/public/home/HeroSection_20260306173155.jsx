...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      ...
      <div className="w-full h-[40px] bg-black mt-2 rounded-b-3xl flex items-center overflow-hidden">
        <marquee behavior="scroll" direction="left" className="text-white font-medium tracking-wide px-2">
