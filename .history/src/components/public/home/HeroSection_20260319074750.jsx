  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      ...
      <div className="w-full h-[40px] bg-[#2c1a10] mt-1 rounded-b-3xl flex items-center overflow-hidden px-4 ">
        ...
        <marquee behavior="scroll" direction="left" onMouseOver={(e) => e.currentTarget.stop()} outMouseOut={(e) => e.currentTarget.start()} scrollamount="5" className="text-gray-300 font-medium tracking-wide ">
          <span className="mx-4">
