...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      ...
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 overflow-hidden shadow-2xl ">
        ...
        <div className="w-[600px] h-[320px] px-20 flex flex-col items-center">
              ...
              <p className="mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati pariatur nostrum ipsa cum deserunt <br />, odit voluptatem maxime officia? Eos, praesentium.</p>
              <div className="flex gap-4 mt-10">
                <button className="bg-amber-800 px-8 py-3 border-[2px] border-orange-800  hover:bg-amber-700 transition">Order Now</button>
                <button className="bg-gray-600 text-white border-[2px] border-gray-500 px-8 py-3  hover:bg-gray-500 transition">View More</button>
              </div>
        </div>
        </div>
      </div>

      <div className="w-full h-[40px] bg-black mt-2 rounded-b-3xl flex items-center overflow-hidden px-4 ">
        <marquee behavior="scroll" direction="left" className="text-white font-medium tracking-wide relative">
          <div className="absolute w-[50px] h-[100%] left-0 top-0 bg-amber-200">asfdasdf</div>
          <span className="text-amber-500 font-bold uppercase">New Menu :</span> 
          <span className="mx-4">
            Double Espresso / Classic Cappuccino / Flat White / Caramel Macchiato / Caffè Mocha / 
            Nitro Cold Brew / Iced Americano / Vanilla Cream Cold Brew / Iced Dirty Latte / Iced Shaken Espresso / 
            Butter Croissant / Chocolate Pain au Chocolat / Blueberry Muffin / Almond Danish / Red Velvet Cake / 
            Sea Salt Cream Latte / Honey Oatmilk Shaken / Pistachio Matcha Latte / Spiced Pumpkin Spice / Iced Rose Lychee Tea
          </span>
        </marquee>
      </div>
