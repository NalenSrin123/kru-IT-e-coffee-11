      ...
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 overflow-hidden shadow-2xl ">
        ...
        <div className="w-[600px] h-[300px] px-20 flex flex-col items-center">
              ...
              <div className="flex gap-5 m-">
                <button className="bg-amber-800 px-8 py-3 mt-10 rounded-lg hover:bg-amber-700 transition">Order Now</button>
                <button className="bg-white text-black border-[2px] border-orange-700 px-8 py-3 mt-10 rounded-lg hover:bg-amber-700 transition">Order Now</button>
              </div>
        </div>
        </div>
      </div>
