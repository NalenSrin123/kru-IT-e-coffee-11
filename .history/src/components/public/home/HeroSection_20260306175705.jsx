      ...
      <div className="w-full h-[40px] bg-[#2c1a10] mt-1 rounded-b-3xl flex items-center overflow-hidden px-4 ">
        ...
        <marquee behavior="scroll" direction="left" onMouseOver={(e) => e.currentTarget.stop()} onMouseOut={(e) => e.currentTarget.start()} scrollamount="5" className="text-gray-300 font-medium tracking-wide ">
          <span className="mx-4">
            ...
            Nitro Cold Brew / Iced Americano / Vanilla Cream Cold Brew / Iced Dirty Latte / Iced Shaken Espresso / Butter Croissant / Chocolate Pain au Chocolat / Blueberry Muffin / Almond Danish / Red Velvet Cake / Sea Salt Cream Latte / Honey Oatmilk Shaken / Pistachio Matcha Latte / Spiced Pumpkin Spice / Iced Rose Lychee Tea
          </span>
        </marquee>
      </div>
