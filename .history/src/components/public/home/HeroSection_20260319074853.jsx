...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      <div className="w-[100%] lg:w-[90%] sm:w-[99%]  m-auto ">
      ...
      <div className="inline-block animate-marquee text-gray-300">
        Double Espresso / Classic Cappuccino / Flat White / Caramel Macchiato / Caffè Mocha / Nitro Cold Brew / Iced Americano / Vanilla Cream Cold Brew / Iced Dirty Latte / Iced Shaken Espresso
      </div>
    </div>
      </div>
