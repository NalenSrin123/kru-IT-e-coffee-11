...
const HeroSection = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => setBgIndex((prev) => (prev + 1) % backgrounds.length), 60000);
    return () => clearInterval(timer);
  }, []);

  return (
    <div className="w-full bg-stone-900 pb-10 space-y-8">
      ...
      <div className="flex justify-center">
        <div className="relative w-[90%] h-[450px] border-[14px] border-[#3d2b1f] rounded shadow-xl overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center pointer-events-none">
            ...
            <h2 className="mt-12 text-white/80 italic text-2xl tracking-widest uppercase border-t border-white/20 pt-4">
