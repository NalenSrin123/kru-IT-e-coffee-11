...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      <div className="w-[100%] lg:w-[90%]  m-auto ">
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 overflow-hidden shadow-2xl ">
        <img src={imgHeroSection} className="absolute inset-0 w-full h-full object-cover rounded-[10px 10px " alt="Hero" />
