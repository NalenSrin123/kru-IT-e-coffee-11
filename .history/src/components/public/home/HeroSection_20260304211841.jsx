        ...
        <div className="absolute inset-0 z-20 flex flex-col md:flex-row items-center md:items-center">
          ...
          <div className="w-full px-6 md:px-50 px-30 py-20 text-center md:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 md:mb-6 text-white">
              Welcome to <br />
              Morning
              <span className="ml-2 border-b-[3px] border-white text-amber-800">
                <Typewriter
                  words={["ETEC"]}
                  loop={0}          // 0 = infinite loop
                  cursor            // show cursor
                  cursorStyle="_"   // cursor style
                  typeSpeed={1000}   // typing speed (ms per letter)
                  deleteSpeed={1000}  // deleting speed (optional)
                  delaySpeed={2000} // wait before deleting (ms)
                />
            </span>
            </h1>
