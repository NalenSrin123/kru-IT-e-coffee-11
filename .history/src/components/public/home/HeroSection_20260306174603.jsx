...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      ...
      <div className="w-full h-[40px] bg-orange-900 mt-2 rounded-b-3xl flex items-center overflow-hidden px-4 ">
        <div className=" w-[150px] h-[100%] flex justify-center items-center bg-black"><span className="text-amber-500 font-bold uppercase">New Menu :</span> </div>
        <marquee behavior="scroll" direction="left" className="text-gray-300 font-medium tracking-wide ">
          <span className="mx-4">
