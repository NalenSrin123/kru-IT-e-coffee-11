...
const HeroSection = () => {
  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      <div className="w-[90%] m-auto border-l-[20px] border-amber-[#3d2b1f">
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 rounded-xl overflow-hidden shadow-2xl border-4 border-[#3d2b1f]">
      ...
      <div className="flex justify-center mt-10">
        <div className="relative w-[100%] h-[450px] border-[14px] border-[#3d2b1f] rounded shadow-xl overflow-hidden">
