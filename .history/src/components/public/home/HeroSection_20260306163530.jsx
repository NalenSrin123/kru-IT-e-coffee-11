  ...
  return (
    <div className="w-full pb-5 space-y-8 ">
      ...
      <div className="relative w-[100%] h-[500px] md:h-[600px] mx-auto mt-5 overflow-hidden shadow-2xl ">
        ...
        <div className="absolute inset-0 bg-black/60 flex flex-col items-center bg-amber-200 justify-center text-white text-center p-5">
      ...
      <div className="flex justify-center mt-10">
        <div className="relative w-[100%] h-[350px] rounded-4xl border-4 border-orange-950 shadow-xl overflow-hidden">
