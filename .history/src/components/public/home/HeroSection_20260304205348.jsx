    ...
    <div>
      ...
      <div className="relative w-full md:w-[90%] h-[500px] md:h-[700px] m-auto mt-4 overflow-hidden ">
        ...
        <div className="absolute inset-0 z-20 flex flex-col md:flex-row items-center md:items-center">
          ...
          {/* Left Content */}
          <div className="w-full md:w-1/2 px-6 md:px-16 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <button className="border border-white text-white hover:bg-white hover:text-black px-6 py-3 rounded-lg transition duration-300">
                View Menu
              </button>
            </div>
