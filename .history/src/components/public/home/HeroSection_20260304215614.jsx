  ...
  return (
    <div>
      ...
      <div className="relative w-full md:w-[90%] h-[500px] md:h-[700px] m-auto mt-4 overflow-hidden ">
        ...
        {/* Overlay */}
       <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_bottom_left,_rgba(0,0,0,0.9),_rgba(0,0,0,0)_70%)] bg-[radial-gradient(circle_at_top_right,_rgba(0,0,0,0.7),_rgba(0,0,0,0)_70%)]"></div>
        {/* Content */}
