...
export default function AboutPage() {
  return (
    <div className="bg-[#f9f8f8] min-h-screen font-sans">
      <nav className="flex justify-between items-center px-6 py-4 bg-[#fafafa]">
        ...
        <div className="text-xl font-bold">
          <img src="/src/assets/images/coffee/logoEtec.png" alt="" />
        </div>

        <div className="flex gap-4 items-center text-sm">
          <a
            href="#"
            className="transition-colors duration-300 hover:text-[#812727] hover:underline"
          >
            ACCOUNT
          </a>
          <a
          ...
          <button className="border px-3 py-1 rounded transition-all duration-300 hover:bg-[#812727] hover:text-white">
            LOGIN
          </button>
        </div>
      </nav>
