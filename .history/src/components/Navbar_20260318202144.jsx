...
const Navbar = () => {
  ...
  return (
    <nav className='w-full bg-[#431407] py-1 text-gray-400 shadow-md'>
      <div className='max-w-7xl mx-auto px-6'>
        <div className='flex items-center justify-between h-16'>
          ...
          <ul className='hidden lg:flex gap-10 text-lg font-medium'>
            ...
            <li className='cursor-pointer hover:text-white transition'>Menu</li>
          ...
          <ul className='hidden lg:flex gap-6 items-center text-lg font-medium'>
            ...
            <li className='cursor-pointer hover:text-white transition'>Cart (0)</li>
            <Link to="/login">
