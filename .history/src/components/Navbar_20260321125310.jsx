      ...
      <div className='max-w-7xl mx-auto px-6'>
        <div className='flex items-center justify-between h-16'>
          ...
          <ul className='hidden lg:flex gap-10 text-lg font-medium'>
            <li>
              <Link to="/" className='cursor-pointer hover:text-orange-400 transition'>Home</Link>
            </li>
            <li>
              <Link to="/menu" className='cursor-pointer hover:text-orange-400 transition'>Menu</Link>
            </li>
            <li>
              <Link to="/about" className='cursor-pointer hover:text-orange-400 transition'>About</Link>
            </li>
            
            <li>
              <Link to="/contact" className='cursor-pointer hover:text-orange-400 transition'>Contact</Link>
            </li>
          </ul>
          ...
          <ul className='hidden lg:flex gap-6 items-center text-lg font-medium'>
            <li>
                <Link to="/cart" className='cursor-pointer hover:text-orange-400 transition'>Cart (0)</Link>
            </li>
            <Link to="/login">
              <button className='px-4 py-2 border rounded-xl hover:bg-orange-400 hover:text-white transition'>
                Login
              </button>
            </Link>
          </ul>
        ...
        {isOpen && (
          <div className='lg:hidden pb-6 '>
            <ul className='flex flex-col gap-4 text-lg font-medium'>
              ...
              <li>
                <Link to="/login">
                  <button className='w-full px-4 py-2 border rounded-xl hover:bg-ora hover:text-white transition'>
                    Login
                  </button>
                </Link>
              </li>
