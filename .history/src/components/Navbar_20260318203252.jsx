...
const Navbar = () => {
  ...
  return (
    <nav className='w-full bg-white text-gray-200 sticky top-0 z-100 shadow-md bg-gradient-to-t from-orange-950/80 to-orange-400/80 ' >
      <div className='max-w-7xl mx-auto px-6'>
        <div className='flex items-center justify-between h-16'>
          ...
          {/* Logo */}
          <div className='w-14 rounded-full p-1 bg-amber-50'>
            <img className='w-[100%] h-full object-contain' src={logo} alt='Logo' />
          </div>
