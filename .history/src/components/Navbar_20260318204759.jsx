      ...
      <div className='max-w-7xl mx-auto px-6'>
        <div className='flex items-center justify-between h-16'>
          ...
          <ul className='hidden lg:flex gap-10 text-lg font-medium'>
            ...
            <li className='cursor-pointer hover: transition'>About</li>
            <li className='cursor-pointer hover: transition'>Menu</li>
            <li className='cursor-pointer hover: transition'>Contact</li>
          </ul>
          ...
          <ul className='hidden lg:flex gap-6 items-center text-lg font-medium'>
            <li className='cursor-pointer hover: transition'>Blog</li>
            <li className='cursor-pointer hover: transition'>Cart (0)</li>
            <Link to="/login">
