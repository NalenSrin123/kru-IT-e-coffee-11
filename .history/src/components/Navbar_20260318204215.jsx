...
const Navbar = () => {
  ...
  return (
    <nav className='w-full bg-white text-gray-200 sticky top-0 z-100 shadow-md bg-gradient-to-t py-1 from-orange-950 to-gray-100/50 to-transparent border-b border-white rounded-b-3xl' >
