  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-gray-500 mb-4">
        <RiArrowLeftLine /> ត្រឡប់ក្រោយ
      </button>

      <h1 className="text-2xl font-bold text-[#361205] mb-6">បន្ថែមអ្នកប្រើប្រាស់ថ្មី</h1>

      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          
          <div>
            <label className="block text-sm font-semibold mb-1">ឈ្មោះពេញ</label>
            <input 
              name="name" 
              type="text" 
              required
          ...
          <div>
            <label className="block text-sm font-semibold mb-1">អ៊ីមែល</label>
            <input 
              name="email" 
              type="email" 
              required
          ...
          <div>
            <label className="block text-sm font-semibold mb-1">តួនាទី</label>
            <select 
              name="role" 
              className="w-full px-4 py-2 bg-gray-50 border rounded-xl outline-none"
              onChange={handleChange}
          ...
          <div>
            <label className="block text-sm font-semibold mb-1">លេខសម្ងាត់</label>
            <input 
              name="password" 
              type="password" 
              required
