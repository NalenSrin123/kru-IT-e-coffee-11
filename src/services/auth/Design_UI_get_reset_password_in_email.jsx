...
function Design_UI_get_reset_password_in_email() {
  return (
    <div className='flex justify-center items-center'>
      <div className=' border-1 border-gray-400 lg:w-220 lg:h-110 md:w-150 md:h-115 sm:w-100 sm:h-107 rounded-2xl mt-20 shadow-xl'>
        ...
        <div className='lg:px-13 md:px-10 sm:px-8'>
          ...
          <p className='font-sans font-serif font-lg sm:text-sm md:text-base lg:text-lg'>Need to reset your password? No problem! Just click the button below and you'll be on your way. If you did not make this request,
